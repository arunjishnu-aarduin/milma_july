    ...
    if (console.log("run_datatables"), "undefined" != typeof $.fn.DataTable) {
        ...
        var a = function() {
            $("#datatable-buttons").length && $("#datatable-buttons").DataTable({
                ...
                responsive: !0
            }),        $("#datatable-buttons1").length && $("#datatable-buttons1").DataTable({
                        dom: "Bfrtip",
                        buttons: [{
                            extend: "copy",
                            className: "btn-sm"
                        ...
                        responsive: !0
                    }),        $("#datatable-buttons2").length && $("#datatable-buttons2").DataTable({
                                dom: "Bfrtip",
                                buttons: [{
                                    extend: "copy",
                                    className: "btn-sm"
                                ...
                                responsive: !0
                            }),        $("#datatable-buttons3").length && $("#datatable-buttons3").DataTable({
                                        dom: "Bfrtip",
                                        buttons: [{
                                            extend: "copy",
                                            className: "btn-sm"
                                        ...
                                        responsive: !0
                                    }),        $("#datatable-buttons4").length && $("#datatable-buttons4").DataTable({
                                                dom: "Bfrtip",
                                                buttons: [{
                                                    extend: "copy",
                                                    className: "btn-sm"
        ...
        }(), $("#datatable").dataTable(),$("#datatablemy").dataTable(), $("#datatable-keytable").DataTable({
            keys: !0
